...
e %>% filter(sample == 12 | sample == 11 | sample == 10 | sample == 9 |sample == 8 | sample == 7 | sample == 6 ) %>% group_by(sample) %>% ggplot() + geom_boxplot(mapping = aes(x = factor(sample), y = value, group = factor(sample)))
...
e %>% filter(sample == 10 | sample == 9 |sample == 8 | sample == 7 | sample == 6 ) %>% group_by(sample) %>% ggplot() + geom_line(mapping = aes(x = reading, y = value, group = factor(sample), color = factor(sample))) 
e %>% filter(sample == 5 | sample == 4 |sample == 3 | sample == 2 | sample == 1 | sample == 10 | sample == 9) %>% group_by(sample) %>% ggplot() + geom_line(mapping = aes(x = reading, y = value, group = factor(sample), color = factor(sample)))
```
...
```{r}
e <- read.csv("/home/lisa/projects/biolab/hardware/fluorometer/shd17/hardware/data/c3x3_3.csv")
e %>% filter(sample == 12 | sample == 11 | sample == 10 | sample == 9 |sample == 8 | sample == 7 | sample == 6 ) %>% group_by(sample) %>% ggplot() + geom_boxplot(mapping = aes(x = factor(sample), y = value, group = factor(sample)))
e %>% filter(sample == 10 | sample == 9 |sample == 8 | sample == 7 | sample == 6 ) %>% group_by(sample) %>% ggplot() + geom_boxplot(mapping = aes(x = factor(sample), y = value, group = factor(sample))) + scale_x_discrete(labels = rev(c("Ctrl - Water", "Ctrl - no DNA", "2ng/ul", "3ng/ul", "5ng/ul")))
e %>% filter(sample == 5 | sample == 4 |sample == 3 | sample == 2 | sample == 1 | sample == 10 | sample == 9) %>% group_by(sample) %>% ggplot() + geom_boxplot(mapping = aes(x = factor(sample), y = value, group = factor(sample)))+ scale_x_discrete(labels = rev(c("Ctrl - Water", "Ctrl - no DNA", "10ng/ul", "25ng/ul", "50ng/ul", "75ng/ul", "100ng/ul")))
e %>% filter(sample == 10 | sample == 9 |sample == 8 | sample == 7 | sample == 6 ) %>% group_by(sample) %>% ggplot() + geom_line(mapping = aes(x = reading, y = value, group = factor(sample), color = factor(sample))) 
